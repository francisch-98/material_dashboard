                            ...
                            <div
                                ...
                                <div class="card card-plain">
                                    <div class="card-header">
                                        ...
                                        <p class="mb-0">Ingrese su nombre, correo electrónico y contraseña para registrarse</p>
                                    </div>
                                    <div class="card-body">
                                        <form wire:submit.prevent ="store">
                                            ...
                                            <div class="text-center">
                                                <button type="submit"
                                                    class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0">Inscribirse</button>
                                            </div>
                                        </form>
                                    </div>
